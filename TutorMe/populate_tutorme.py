...
def populate():
    ...
    teachers = [
        {'email': 'jarrodmoon@gmail.com', 'password': 'jarrodmoon0', 'first_name': 'Jarrod',
         'last_name': 'Moon', 'description': 'Teaching geometry and trigonometry for 23 years now at a high school. Love my job so much, I want to do it in my free time too!', 'location': 'Glasgow', 'rating': 5,
         'categories': ["Geometry", "Trigonometry"]},
        {'email': 'malakaireader@gmail.com', 'password': 'malakaireader0', 'first_name': 'Malakai',
         'last_name': 'Reader', 'description': 'Yes, I won the national poetry competition in 2004, 2007 and 2016. No, you will probably never be half as good as me. But maybe, if you pay attention, you can still learn something.', 'location': 'Glasgow', 'rating': 1,
         'categories': ["Art", ]},
        {'email': 'shivamallman@gmail.com', 'password': 'shivamallman0', 'first_name': 'Shivam',
         'last_name': 'Allman', 'description': 'Borges said there are only four stories to tell: a love story between two people, a love story between three people, the struggle for power and the voyage. All of us writers rewrite these same stories ad infinitum.', 'location': 'Glasgow', 'rating': 4,
         'categories': ["Storytelling", ]},
        {'email': 'danielatran@gmail.com', 'password': 'danielatran0', 'first_name': 'Daniela',
         'last_name': 'Tran', 'description': 'Phd Biologist, mother and writer of "An illustrated story of biology."', 'location': 'Glasgow', 'rating': 5,
         'categories': ["Biology", ]},
        {'email': 'francescosullivan@gmail.com', 'password': 'francescosullivan0', 'first_name': 'Francesco ',
         'last_name': 'Sullivan', 'description': 'Owner of Francesco\'s, self-made millionaire, philanthropist, visionary...and willing to share my experience and knowledge.', 'location': 'Glasgow', 'rating': 4,
         'categories': ["Entrepreneurship", ]},
        {'email': 'weronikaconolly@gmail.com', 'password': 'weronikaconolly0', 'first_name': 'Weronika',
         'last_name': 'Conolly', 'description': 'You hated algebra as a kid. Maybe now is the time to change your mind? I have been teaching algebra for 14 years and am willing to help both newcomers and more experienced students improve their skills.', 'location': 'Glasgow', 'rating': 5,
         'categories': ["Mathematics", ]},
        {'email': 'ericclark@gmail.com', 'password': 'ericclark0', 'first_name': 'Eric',
         'last_name': 'Clark', 'description': 'Former employee of GoldmanSachs. Expert at macroeconomics.', 'location': 'Glasgow', 'rating': 3,
         'categories': ["Macroeconomics", "Economics", "Microeconomics"]},
        {'email': 'anissabrettr@gmail.com', 'password': 'anissabrett0', 'first_name': 'Anissa',
         'last_name': 'Brett', 'description': 'Painter, artist, free-thinker. Want to help like-minded people achieve their potential and have fun while creating art. “I dream my painting and I paint my dream.” ― Vincent Willem van Gogh ', 'location': 'Glasgow', 'rating': 4,
         'categories': ["Art", ]},
        {'email': 'munalindsey@gmail.com', 'password': 'munalindsey0', 'first_name': 'Muna',
         'last_name': 'Lindsey', 'description': 'History teacher, author of "Ruins and Stories". Apologies if I do not get back to you immediately. “Study the past if you would define the future.”― Confucius ', 'location': 'Glasgow', 'rating': 4,
         'categories': ["History", ]},
        {'email': 'kamilestrada@gmail.com', 'password': 'kamilestrada0', 'first_name': 'Kamil',
         'last_name': 'Estrada', 'description': 'Multilingual: I speak Java, Python, Scala, C++ and Swift. Yes bad jokes come with the teaching I\'m afraid. But I vouch they\'re worth it!', 'location': 'Glasgow', 'rating': 2,
